...
<pre class="wp-block-code"><code>nohup &#91;process] &</code></pre>
...
<pre class="wp-block-code"><code># 출력이름 변경
nohup &#91;process] &gt; &#91;파일이름] &
# 파일 생성 금지
nohup &#91;process] &gt; /dev/null &</code></pre>
...
<pre class="wp-block-code"><code>ps -ef | grep &#91;process]</code></pre>
...
<ul class="wp-block-list">
  <li>
    참고 <ul class="wp-block-list">
      <li>
        <a href="https://gracefulprograming.tistory.com/128">https://gracefulprograming.tistory.com/128</a>
      </li>
    </ul>
    
    <ul class="wp-block-list">
      <li>
        <a href="https://joonyon.tistory.com/entry/쉽게-설명한-nohup-과-백그라운드-명령어-사용법">https://joonyon.tistory.com/entry/쉽게-설명한-nohup-과-백그라운드-명령어-사용법</a>
      </li>
    </ul>
  </li>
</ul>
